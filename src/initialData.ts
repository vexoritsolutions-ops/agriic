...
export async function seedDatabaseIfEmpty() {
  // Frontend only mock seeding
  console.log("Mock seeding: database is ready in frontend memory.");
}

export const SEED_BLOG_POSTS: BlogPost[] = [
  {
    id: "post_1",
    title: "Understanding NPK Ratios for Soil Remineralization",
    category: "Soil Health",
    readTime: "5 min",
    date: "2026-07-10",
    img: "/agriic_core_npk.png",
    excerpt: "Learn how Nitrogen, Phosphorus, and Potassium influence crop development and how to balance them dynamically."
  },
  {
    id: "post_2",
    title: "How Organic Bio-Ingredients Boost Root Systems",
    category: "Bio-Science",
    readTime: "8 min",
    date: "2026-07-12",
    img: "/agriic_bloom_booster.png",
    excerpt: "Discover the symbiotic relationship between humic acids, seaweed extracts, and soil microbial activity."
  },
  {
    id: "post_3",
    title: "Transitioning to 100% Acid-Free Pest Management",
    category: "Pest Control",
    readTime: "6 min",
    date: "2026-07-15",
    img: "/agriic_membership.png",
    excerpt: "A practical guide for implementing cold-pressed neem oils and biological defense enhancers in modern farms."
  }
];
...
export const SEED_TESTIMONIALS: Testimonial[] = [
  {
    id: "test_1",
    name: "Gurpreet Singh",
    quote: "Agriic changed how we view soil health. Our wheat yield increased by 22% in just one season using their organic NPK blends.",
    img: "/farmerimg1.jpeg"
  },
  {
    id: "test_2",
    name: "Suresh Patel",
    quote: "The soil test diagnostic was fast, and the custom nutrition plan completely resolved the yellowing on our cotton crops.",
    img: "/farmerbg1.jpeg"
  },
  {
    id: "test_3",
    name: "Bhavana Reddy",
    quote: "Excellent botanical formulas that don't harm the earth. Our chillies look healthier than they ever have.",
    img: "/farmerimg1.jpeg"
  }
];
...
export const SEED_INGREDIENTS: Ingredient[] = [
  {
    ...
    desc: "A natural botanical shield that deters sucking pests and protects foliage integrity without leaving chemical residues.",
    img: "/agriic_bloom_booster.png"
  },
  {
    id: "ing_2",
    name: "Active Humic Acid",
    desc: "Optimizes soil structure, improves organic carbon retention, and unlocks bound phosphate ions in acidic clay.",
    img: "/agriic_core_npk.png"
  },
  {
    id: "ing_3",
    name: "Bio-Seaweed Extract",
    desc: "Provides over 60 chelated trace elements and growth hormones to expand root networks and stimulate flower budding.",
    img: "/agriic_bloom_booster.png"
  }
];

export const SEED_GOOGLE_REVIEWS: GoogleReview[] = [
  {
    id: "rev_1",
    name: "Arjun Mehta",
    text: "Top-notch customer support and high-potency organic formulas. Highly recommend Agriic!"
  },
  {
    id: "rev_2",
    name: "Preeti Sharma",
    text: "The delivery is fast, and the packaging is plastic-free. 5 stars all the way."
  },
  {
    id: "rev_3",
    name: "Vijay Gowda",
    text: "Our cooperative has transitioned 50 acres to Agriic inputs. The soil moisture retention has improved drastically."
  }
];

export const SEED_EXPECTATIONS: Expectation[] = [
  {
    id: "exp_1",
    label: "Verify Soil Acid Levels (pH)",
    img: "/plant_stage_1_1782062561659.png",
    ok: true
  },
  {
    id: "exp_2",
    label: "Apply Active Humic Reagents",
    img: "/plant_stage_2_1782062575085.png",
    ok: true
  },
  {
    id: "exp_3",
    label: "Stimulate Budding and Bloom",
    img: "/plant_stage_3_1782062587082.png",
    ok: true
  }
];
...
export const SEED_QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    id: "q_1",
    question: "What is your primary crop type?",
    options: ["Grains & Wheat", "Fruits & Vegetables", "Spices & Chillies", "Flowers & Ornamentals"]
  },
  {
    id: "q_2",
    question: "Have you noticed leaf yellowing (chlorosis) in your crop?",
    options: ["Yes, extensive yellowing", "No, leaves are healthy", "Only on older lower leaves", "Only on new top shoots"]
  },
  {
    id: "q_3",
    question: "What is your typical watering frequency?",
    options: ["Daily drip lines", "Every 3-5 days flood", "Weekly rainfed", "Irregular / as needed"]
  }
];
