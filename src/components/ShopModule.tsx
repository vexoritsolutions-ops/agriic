  ...
  return (
    <>
      ...
      <div className="block md:hidden h-screen overflow-hidden bg-[#F4F7F5] flex flex-col relative font-sans">
        {/* Mobile Header */}
        <header className="sticky top-0 z-40 bg-white border-b border-gray-150 px-4 py-1.5 flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center">
            <img src="/logo2-green.svg" alt="Agriic Logo" className="h-10 w-auto object-contain" />
          </a>
        ...
        <div className="px-4 py-2.5 bg-white border-b border-gray-100">
          <div className="flex items-center bg-white border border-gray-300 rounded-full px-4 py-1.5 shadow-sm">
            ...
            >
              ...
              <option value="grains-millet">Organic Food</option>
        ...
        <div className="flex flex-1 overflow-hidden" style={{ height: 'calc(100vh - 108px)' }}>
          ...
          <main className="flex-1 bg-white overflow-y-auto p-3 no-scrollbar relative flex flex-col pb-24">
            ...
            {/* Added Trust Sections at bottom of mobile product grid */}
            <div className="mt-8">
              <TrustSections />
            </div>
          </main>
      ...
      <div className="sticky top-0 z-50 w-full bg-white border-b border-gray-200 shadow-sm mb-0">
        {/* Top Bar */}
        <div className="w-full px-4 md:px-8 lg:px-12 py-1.5 flex items-center justify-between gap-4 md:gap-6 max-w-[1600px] mx-auto">

          {/* Logo */}
          <a href="#home" className="flex items-center shrink-0">
            <img src="/logo2-green.svg" alt="Agriic Logo" className="h-10 w-auto object-contain hover:opacity-85 transition-opacity" />
          </a>
          ...
          <div className="flex-1 max-w-2xl hidden md:flex">
            <div className="flex items-center w-full border border-gray-300 rounded-lg bg-gray-50 pl-4 pr-1 py-1 focus-within:border-[#2D5A3F] focus-within:ring-2 focus-within:ring-[#2D5A3F]/15 focus-within:bg-white transition-all">
              <Search className="w-4 h-4 text-gray-400 shrink-0" />
              <input
                type="text"
              ...
              <select
                className="bg-transparent text-xs font-bold text-gray-600 border-l border-gray-200 pl-3 pr-6 py-1 mx-1 focus:outline-none cursor-pointer appearance-none bg-[url('data:image/svg+xml;charset=US-ASCII,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%22292.4%22%20height%3D%22292.4%22%3E%3Cpath%20fill%3D%22%25234A5568%22%20d%3D%22M287%2069.4a17.6%2017.6%200%200%200-13-5.4H18.4c-5%200-9.3%201.8-12.9%205.4A17.6%2017.6%200%200%200%200%2082.2c0%205%201.8%209.3%205.4%2012.9l128%20127.9c3.6%203.6%207.8%205.4%2012.8%205.4s9.2-1.8%2012.8-5.4L287%2095c3.5-3.5%205.4-7.8%205.4-12.8%200-5-1.9-9.2-5.5-12.8z%22%2F%3E%3C%2Fsvg%3E')] bg-[length:8px_8px] bg-[right_8px_center] bg-no-repeat"
                value={productFilter}
                onChange={(e) => setProductFilter(e.target.value)}
              >
                <option value="all">All Categories</option>
      ...
      {/* MOBILE BOTTOM NAV */}
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center p-3 z-[9999] pb-5 shadow-[0_-4px_12px_rgba(0,0,0,0.05)]">
