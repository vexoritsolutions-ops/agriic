...
export const ShopModule: React.FC<ShopModuleProps> = ({
  ...
  return (
    <>
      ...
      <div className="block md:hidden h-screen overflow-hidden bg-[#F4F7F5] flex flex-col relative font-sans">
        ...
        <div className="flex flex-1 overflow-hidden" style={{ height: 'calc(100vh - 108px)' }}>
          ...
          <main className="flex-1 bg-white overflow-y-auto p-3 no-scrollbar relative flex flex-col pb-24">
            ...
            {/* WHY CHOOSE AGRIIC — mobile section */}
            <div className="mt-4 mb-4 rounded-2xl overflow-hidden" style={{
              background: 'linear-gradient(135deg, #0f2d1e 0%, #1a4a2e 40%, #0d2818 100%)',
              boxShadow: '0 8px 30px rgba(15,45,30,0.3)',
            }}>
              {/* Branding panel */}
              <div className="px-5 pt-5 pb-4 border-b border-white/10">
                <span className="text-[9px] font-black text-[#D4A373] uppercase tracking-[0.3em] block mb-1.5">Our Promise</span>
                <h3 className="text-xl font-black text-white leading-tight mb-2">
                  Why Choose <span className="text-[#5ecb8e]">Agriic?</span>
                </h3>
                <div className="flex gap-2 mb-3">
                  <div className="w-8 h-[2px] rounded-full bg-[#D4A373]"/>
                  <div className="w-3 h-[2px] rounded-full bg-[#D4A373]/40"/>
                </div>
                <p className="text-white/55 text-[10px] font-semibold leading-relaxed mb-4">
                  Every product is crafted from nature, tested in labs, and delivered with care.
                </p>
                {/* Stats */}
                <div className="grid grid-cols-3 gap-2">
                  {[{ num: '5K+', label: 'Customers' }, { num: '200+', label: 'Products' }, { num: '4.8★', label: 'Rating' }].map(s => (
                    <div key={s.label} className="text-center bg-white/5 rounded-xl py-2">
                      <div className="text-base font-black text-[#5ecb8e]">{s.num}</div>
                      <div className="text-[8px] font-bold text-white/40 uppercase tracking-wider mt-0.5">{s.label}</div>
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div className="p-3 grid grid-cols-2 gap-2.5">
                {[
                  { icon: <Leaf className="w-4 h-4"/>, color: '#5ecb8e', bg: 'rgba(94,203,142,0.12)', title: '100% Organic', desc: 'Certified ingredients, no hidden additives.' },
                  { icon: <ShieldCheck className="w-4 h-4"/>, color: '#60a5fa', bg: 'rgba(96,165,250,0.12)', title: 'Lab Tested', desc: 'Purity & safety tested before dispatch.' },
                  { icon: <Truck className="w-4 h-4"/>, color: '#f59e0b', bg: 'rgba(245,158,11,0.12)', title: 'Fast Delivery', desc: '2-day pan-India shipping with tracking.' },
                  { icon: <Package className="w-4 h-4"/>, color: '#34d399', bg: 'rgba(52,211,153,0.12)', title: 'Eco Packaging', desc: 'Biodegradable, plastic-free packaging.' },
                  { icon: <CheckCircle className="w-4 h-4"/>, color: '#a78bfa', bg: 'rgba(167,139,250,0.12)', title: 'Quality Assured', desc: 'FSSAI certified, global organic standards.' },
                  { icon: <MessageCircle className="w-4 h-4"/>, color: '#fb923c', bg: 'rgba(251,146,60,0.12)', title: '24/7 Support', desc: 'Agri-nutritionists guide every purchase.' },
                ].map((feat, i) => (
                  <div
                    key={i}
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-extrabold text-white text-[11px] mb-0.5">{feat.title}</h4>
                      <p className="text-white/45 text-[9px] font-semibold leading-relaxed">{feat.desc}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* ═══════════════════════════════════════════════════════
                MOBILE: AGRIIC VS THE REST
            ═══════════════════════════════════════════════════════ */}
            <div className="bg-[#F4F7F5] px-4 py-8 mt-2">
              <div className="text-center mb-6">
                <span className="text-[10px] font-black text-[#D4A373] uppercase tracking-[0.3em] block mb-2">Why Choose Us</span>
                <h2 className="text-2xl font-black text-[#1a2a1e] mb-2">Agriic <span className="text-[#2D5A3F]">vs</span> the Rest</h2>
                <p className="text-xs text-slate-500 font-semibold">See how we compare against local nurseries.</p>
              </div>
              <div className="rounded-2xl overflow-hidden border border-gray-100 shadow-sm bg-white">
                <div className="overflow-x-auto">
                  <table className="w-full text-[10px] border-collapse">
                    <thead>
                      <tr>
                        <th className="text-left px-3 py-3 bg-[#f8f8f6] font-black text-slate-500 uppercase tracking-wider text-[8px] border-b border-gray-100">Feature</th>
                        <th className="px-2 py-3 bg-[#f8f8f6] font-black text-slate-400 uppercase tracking-wider text-[8px] border-b border-gray-100 text-center">Local<br/>Nurseries</th>
                        <th className="px-2 py-3 bg-[#0f2d1e] text-center border-b border-[#1a4a2e]">
                          <div className="flex items-center justify-center gap-1.5">
                            <img src="/logo2.jpeg" alt="Agriic" className="h-4 w-4 rounded object-cover" />
                            <span className="font-black text-white text-[9px]">Agriic</span>
                          </div>
                        </th>
                        <th className="px-2 py-3 bg-[#f8f8f6] font-black text-slate-400 uppercase tracking-wider text-[8px] border-b border-gray-100 text-center">Others</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        { feature: 'Plant Quality', local: '✕', agriic: '✓ Lab-Tested', others: '~' },
                        { feature: 'Pest Control', local: '✕', agriic: '✓ Controlled', others: '✕' },
                        { feature: 'Organic Certified', local: '✕', agriic: '✓ FSSAI', others: '✕' },
                        { feature: 'Soil Quality', local: 'Standard', agriic: '✓ Pre-mixed', others: 'Standard' },
                        { feature: 'After-sale Help', local: 'None', agriic: '24/7 Support', others: 'None' },
                        { feature: 'Guarantee', local: 'None', agriic: '✓ 14-day', others: 'Cond.' },
                      ].map((row, i) => (
                        <tr key={i} className={`border-b border-gray-50 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
                          <td className="px-3 py-2.5 font-bold text-slate-700 text-[9px]">{row.feature}</td>
                          <td className="px-2 py-2.5 text-center text-[10px] text-red-400 font-black">{row.local}</td>
                          <td className="px-2 py-2.5 text-center text-[9px] font-black text-[#2D5A3F] bg-[#f0faf4]">{row.agriic}</td>
                          <td className="px-2 py-2.5 text-center text-[10px] text-slate-400 font-bold">{row.others}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            {/* ═══════════════════════════════════════════════════════
                MOBILE: STUCK WITH PLANT CARE
            ═══════════════════════════════════════════════════════ */}
            <div className="px-4 pb-8 bg-[#F4F7F5]">
              <div
                className="relative rounded-3xl overflow-hidden flex flex-col items-center gap-6 px-6 py-8"
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  <div className="flex items-center justify-center gap-3 mb-3">
                    <img src="/logo2.jpeg" alt="Agriic" className="h-9 w-9 rounded-xl object-cover shadow-lg" />
                    <span className="text-xl font-black text-white tracking-tight">Agriic.</span>
                  </div>
                  <h2 className="text-xl font-black text-white leading-snug mb-2">Stuck with plant care?</h2>
                  <p className="text-white/70 text-xs font-semibold">We're here to help — reach our expert agri-nutritionists anytime.</p>
                </div>
                <div className="relative z-10 flex flex-col items-center gap-2">
                  <a
                    ...
                    className="flex items-center gap-2.5 bg-[#1a2a1e] hover:bg-black text-white font-black text-xs px-6 py-3 rounded-2xl transition-all shadow-xl"
                  >
                    <svg className="w-4 h-4 fill-[#25D366] shrink-0" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                    Chat With Us
                  </a>
                  <p className="text-white/50 text-[9px] font-semibold">Available 9AM – 9PM, 7 days a week</p>
                </div>
              </div>
            </div>

            {/* ═══════════════════════════════════════════════════════
                MOBILE: CONSCIOUS GARDENING FAQs — LAST
            ═══════════════════════════════════════════════════════ */}
            <div className="px-4 py-8 bg-[#F4F7F5]">
              <div className="text-center mb-8">
                <p className="text-[10px] font-black text-[#D4A373] uppercase tracking-[0.25em] mb-1">💬 Common Queries</p>
                <h3 className="text-lg font-black text-slate-800">Conscious Gardening FAQs</h3>
              ...
              <div className="bg-white border border-gray-100 rounded-[24px] p-4 shadow-sm space-y-2">
                {[
                  ...
                  <details key={i} className="group border-b border-gray-100 last:border-none py-4 cursor-pointer">
                    <summary className="flex items-center justify-between text-[11px] font-extrabold text-slate-800 uppercase tracking-wide list-none focus:outline-none select-none">
                      <span>{faq.q}</span>
      ...
      ═══════════════════════════════════════════════════════ */}
      <div className="px-3 sm:px-4 md:px-8 lg:px-12 py-6 mt-4">
        <div
        ...
        {/* ═══════════════════════════════════════════════════════
            DESKTOP: AGRIIC VS THE REST
        ═══════════════════════════════════════════════════════ */}
        <div className="bg-[#F4F7F5] px-8 lg:px-12 py-12">
          <div className="max-w-5xl mx-auto">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                <tr>
                  <th className="text-left px-6 py-4 bg-[#f8f8f6] font-black text-slate-500 uppercase tracking-wider text-xs w-48 border-b border-gray-100">Feature</th>
                  <th className="px-4 py-4 bg-[#f8f8f6] font-black text-slate-500 uppercase tracking-wider text-xs border-b border-gray-100 text-center">
                  ...
                  <th className="px-4 py-4 bg-[#0f2d1e] text-center border-b border-[#1a4a2e]">
                    <div className="flex items-center justify-center gap-2">
                      <img src="/logo2.jpeg" alt="Agriic" className="h-6 w-6 rounded-md object-cover" />
                      <span className="font-black text-white text-sm">Agriic</span>
                    </div>
              ...
              <tbody className="bg-white">
                {[
                  { feature: 'Plant / Product Quality', sub: 'What you receive', local: { val: '✕', note: 'Poor health, no quality checks' }, agriic: { note: 'Green, healthy & lab-tested' }, others: { val: '~', note: 'Inconsistent' } },
                  ...
                  { feature: 'Organic Certified', sub: 'FSSAI / global standards', local: { val: '✕', note: 'Not certified' }, agriic: { note: 'Certified organic' }, others: { val: '✕', note: 'Usually not' } },
                  ...
                  <tr key={i} className={`border-b border-gray-50 transition-colors hover:bg-gray-50/60 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}`}>
                    <td className="px-6 py-4">
                      <div className="font-extrabold text-[#1a2a1e] text-xs">{row.feature}</div>
                      <div className="text-[10px] text-slate-400 font-medium mt-0.5">{row.sub}</div>
                    </td>
                    <td className="px-4 py-4 text-center">
                      <div className="text-lg font-black text-red-400">{row.local.val}</div>
                      <div className="text-[10px] text-slate-400 font-medium mt-0.5">{row.local.note}</div>
                    </td>
                    <td className="px-4 py-4 text-center bg-[#f0faf4] border-x border-emerald-100">
                      <div className="w-6 h-6 bg-[#2D5A3F] rounded-full flex items-center justify-center mx-auto mb-1">
                        <svg className="w-3.5 h-3.5 text-white" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24"><path d="M5 13l4 4L19 7"/></svg>
                      </div>
                      <div className="text-[10px] font-black text-[#2D5A3F]">{row.agriic.note}</div>
                    </td>
                    <td className="px-4 py-4 text-center">
                      <div className="text-lg font-black text-slate-400">{row.others.val}</div>
                      <div className="text-[10px] text-slate-400 font-medium mt-0.5">{row.others.note}</div>
                    </td>
                  </tr>
                ))}
              </tbody>
      ...
      {/* ═══════════════════════════════════════════════════════
          SHARED: STUCK WITH PLANT CARE (mobile + desktop)
      ═══════════════════════════════════════════════════════ */}
      ...
      {/* ═══════════════════════════════════════════════════════
          SHARED: CONSCIOUS GARDENING FAQs — LAST (mobile + desktop)
      ═══════════════════════════════════════════════════════ */}
